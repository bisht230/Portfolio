...
const Profile = () => {
  ...
  return (
    ...
    >
      ...
      <Box alignSelf="center" px="35" py="25" scrollBehavior="smooth" alignItems="center">
          <Flex className="flexCard" direction={ isNotSmallerScreen ? "row" : "column"} mt={isNotSmallerScreen ? "0" : "2"}>
           ...
           <Flex rounded="xl" direction="column" mt={isNotSmallerScreen ? "0" : "2"} ml={isNotSmallerScreen ? "4" : "0"} bg="gray.100" h="32vh" w="32vh" justify="flex-end">
